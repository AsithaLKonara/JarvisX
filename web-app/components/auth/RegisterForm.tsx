      ...
      <Card className="w-full max-w-md">
        <Card.Content>
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary">Get started with JarvisX today</p>
          </div>
            ...
            <div>
              ...
              {formData.password && (
                <div className="mt-2">
                  ...
                  <p className="text-xs text-text-secondary">{passwordStrength.text}</p>
                </div>
              )}
            </div>
          ...
          <p className="mt-6 text-center text-sm text-text-secondary">
            ...
            <a href="/login" className="text-primary font-medium hover:text-primary-hover">
              Sign in
            </a>
          </p>
        </Card.Content>
